 ...
 * @beginning: The environmental variable to search fo
 ...
 * @line: A double pointer containing the command and
 * @exe_ret: A pointer to the return value of the last
 *
 * Description: Replaces $$ with the current PID, $? with
 */
